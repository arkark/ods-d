module odsD.test.dataStructure.heap.MeldableHeap;
...
unittest {
  ...
  auto heap = new MeldableHeap!(long, "a < b")();
  assert(heap.size == 0);
...
unittest {
  ...
  auto heap = new MeldableHeap!(Vec, "a.lengthSq < b.lengthSq")();
...
unittest {
  ...
  auto heap = new MeldableHeap!long();
  long[] ys = [];
...
unittest {
  ...
  // MeldableHeap should be able to execute `add` and `remove` 10^^5 times within 2000 ms because the time complexity is average O(log n)."
