...
unittest {
  ...
  auto tree = new RedBlackTree!(long, "a < b")();
  assert(tree.size == 0);
...
unittest {
  ...
  auto tree = new RedBlackTree!(Vec, "a.lengthSq < b.lengthSq")();
...
unittest {
  ...
  // RedBlackTree should be able to execute `add`, `find`, 'exists' and `remove` 10^^5 times within 2000 ms because the time complexity is O(log n)."
