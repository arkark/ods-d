...
unittest {
  ...
  // ArrayDeque should be able to execute `insertFront`, `insertBack`, `removeFront` and `removeBack` 10^^6 times within 2000 ms because the time complexity is amortized O(1)."
